    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          StreamBuilder<SessionMeta?>(
            ...
            builder: (context, snapshot) {
              ...
              return CallHeaderBar(
                ...
                duration: meta?.callDuration ?? '00:00',
                language: meta?.currentLanguage?.toUpperCase() ?? 'DETECTING...',
                matchCode: meta?.currentDialect ?? '00-00',
              );
            },
          ),
          ...
          // AI Interpretation Panel - Flexible to prevent overflow
          Flexible(
            child: StreamBuilder<NluResult?>(
                          ...
                          child: SingleChildScrollView(
                            ...
                            if (nlu?.aiSummary != null)
                              ...
                              if (esc != null)
                                EscalationCard(
                                  packet: esc,
                                  onCorrect: () => _pipelineService.sendVerification('correct'),
                                  onPartial: () => _pipelineService.sendVerification('partially_correct'),
                                  onIncorrect: () => _pipelineService.sendVerification('incorrect'),
                                ),
                              ],
                            ),
                          ),
